 ...
 * Use the [reverseImageSearchResults.newInstance] factory method to
...
class reverseImageSearchResults : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment reverseImageSearchResults.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            reverseImageSearchResults().apply {
