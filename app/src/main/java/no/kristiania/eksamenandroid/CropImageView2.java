...
public class CropImageView2 extends ImageView {
    ...
    private LeggTilBilde.OnImageSizeChangedListener onImageSizeChangedListener;
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, com.edmodo.cropper.R.styleable.CropImageView, 0, 0);
        mGuidelinesMode = typedArray.getInteger(com.edmodo.cropper.R.styleable.CropImageView_guidelines, 1);
        mFixAspectRatio = typedArray.getBoolean(com.edmodo.cropper.R.styleable.CropImageView_fixAspectRatio, false);
        mAspectRatioX = typedArray.getInteger(com.edmodo.cropper.R.styleable.CropImageView_aspectRatioX, 1);
        mAspectRatioY = typedArray.getInteger(com.edmodo.cropper.R.styleable.CropImageView_aspectRatioY, 1);
        typedArray.recycle();
    ...
    public void setListeners(@NotNull OnClickListener onClickListener, @NotNull LeggTilBilde.OnImageSizeChangedListener onImageSizeChangedListener) {
