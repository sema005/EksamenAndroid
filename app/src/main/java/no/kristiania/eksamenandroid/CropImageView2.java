...
public class CropImageView2 extends ImageView {
    ...
    private StartScreen.OnImageSizeChangedListener onImageSizeChangedListener;
    ...
    public void setListeners(@NotNull OnClickListener onClickListener, @NotNull StartScreen.OnImageSizeChangedListener onImageSizeChangedListener) {
